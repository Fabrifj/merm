(function(m, hc, tc, global) {
      ...
      return m("div", { class: "mgr-main-graph" }, [
        m("div", {  class: "filter-bar" }, [
          ...
          m("label", [
            ...
            onclick: MgrMainGraphModel.toggleLegend.bind(MgrMainGraphModel),
            checked: MgrMainGraphModel.legendVisible
          })], "Legend"),
          m("label", [
            m("input[type=checkbox]", {
            onclick: MgrMainGraphModel.toggler("consumptionKWhAvg").bind(MgrMainGraphModel),
            checked: MgrMainGraphModel.visibleMap["consumptionKWhAvg"]
          })], "kWh Consumption"),
          m("label", [
            m("input[type=checkbox]", {
            onclick: MgrMainGraphModel.toggler("onPeakDemand").bind(MgrMainGraphModel),
            checked: MgrMainGraphModel.visibleMap["onPeakDemand"]
          })], "On Peak Demand"),
          m("label", [
            m("input[type=checkbox]", {
            onclick: MgrMainGraphModel.toggler("costAvgPerDay").bind(MgrMainGraphModel),
            checked: MgrMainGraphModel.visibleMap["costAvgPerDay"]
          })], "Avg Cost Per Day"),
          m("label", [
            m("input[type=checkbox]", {
            onclick: MgrMainGraphModel.toggler("baseline").bind(MgrMainGraphModel),
            checked: MgrMainGraphModel.visibleMap["baseline"]
          })], "Baseline"),
          m("label", [
            m("input[type=checkbox]", {
            onclick: MgrMainGraphModel.toggler("goal").bind(MgrMainGraphModel),
            checked: MgrMainGraphModel.visibleMap["goal"]
          })], "Goals")
        ]),
  ...
  global.MgrMainGraph = {
    ...
    mount: function () {
      m.mount(document.querySelector(this.el), MgrMainGraph);
      return this;
    },
    graph: function () {
      MgrMainGraphModel.setOptions(_.omit(this.options, 'el'))
      // High charts expects the actual id name
     MgrMainGraphModel.chart = hc.chart(GRAPH_EL, MgrMainGraphModel.graph)
     return this;
    }
  };
