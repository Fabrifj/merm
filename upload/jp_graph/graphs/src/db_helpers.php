...
function fetch_summary_report_mod3($log, $loopname, $start_date, $end_date) {
    ...
    $monthlyReport = [
        ...
        'TimeOnPeakDemand' => $maxPeak["max_field"] != 0 ? $maxPeak["max_time"] : '1970-01-01 00:00:00',
        'OffPeakDemand' => isset($maxOffPeak["max_field"]) ? $maxOffPeak["max_field"] : 0, 
        'TimeOffPeakDemand' => $maxOffPeak["max_field"] != 0 ? $maxOffPeak["max_time"] : '1970-01-01 00:00:00',
