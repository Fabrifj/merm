...
DEFINE("FF_LUCSANSUN",100);
DEFINE("FF_CALIBRI",101);
...
class TTF {
    ...
    function __construct() {
		...
		FF_LUCSANSUN => array(FS_NORMAL =>'lucsansun.ttf',
			FS_BOLD =>'lucisansunbd.ttf',
			FS_ITALIC => 'lucisansuni.ttf',
			FS_BOLDITALIC => 'lucisansunbi.ttf'),
		FF_CALIBRI => array(FS_NORMAL =>'CALIBRI.TTF',
