        ...
        switch ($type) {
            case 'device001':
                return new RecordsTypeStandard($timezone,$data['time'],$data['error'],$data['Energy_Consumption'],$loopName,
                    ...
                    $data['Power_Factor'] * 100,$data['Current'],$data['Real_Power_phase_A'],
                    $data['Real_Power_phase_B'],$data['Real_Power_phase_C'],$data['Power_Factor_phase_A']* 100,
                    $data['Power_Factor_phase_B']* 100,$data['Power_Factor_phase_C']* 100,$data['Voltage_phase_A_B'],
            ...
            case 'device002':
                return new RecordsTypeStandard($timezone,$data['time'],$data['error'],$data['Accumulated_Real_Energy:_Net_Import__Export'],$loopName,
                    ...
                    $data['Total_Power_Factor_Total_KW_/_Total_KVA']* 100,$data['Current_Average_of_Active_Phases'],$data['Real_Power_Phase_A'],
                    $data['Real_Power_Phase_B'],$data['Real_Power_Phase_C'],$data['Power_Factor_Phase_A']* 100,
                    $data['Power_Factor_Phase_B']* 100,$data['Power_Factor_Phase_C']* 100,$data['Voltage_Phase_AB'],
            ...
            case 'device248':
                return new RecordsTypeStandard($timezone,$data['time'],$data['error'],$data['Accumulated_Real_Energy:_Net_Import__Export'],$loopName,
                    $data['Total_Net_Instantaneous_Real_P_Power']* 100,$data['Total_Net_Instantaneous_Reactive_Q_Power'],$data['Total_Net_Instantaneous_Apparent_S_Power_vector_sum'],
                    $data['Total_Power_Factor_Total_KW_/_Total_KVA'],$data['Current_Average_of_Active_Phases'],$data['Real_Power_Phase_A']* 100,
